...
$query_gossip = "select id_posting, date, judul, kriteria, artikel, gambar from posting where kriteria='Info Terkini' order by id_posting desc";

$gossip = mysql_query($query_gossip);
...
================================================== -->
  <body>
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="page_gossip.php">Informasi Terkini</a></li>
    ...
    <div class="container marketing">
      ...
      <?php
      $i = 1;
      while($row = mysql_fetch_assoc($gossip))
      {
        ?>
        <div class="konten">
...
$query_gossip = "select id_posting, date, judul, kriteria, artikel, gambar from posting where kriteria='Gossip & Info Terkini' order by id_posting desc";
