...
$query_tips = "select id_posting, date, judul, kriteria, artikel, gambar from posting where kriteria='Tips & Trik' order by id_posting desc";

$tips = mysql_query($query_tips);
...
================================================== -->
  <body>
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="page_tips.php">Tips&Trik</a></li>
    ...
    <div class="container marketing">
      ...
      <?php
      $i = 1;
      while($row = mysql_fetch_assoc($tips))
      {
        ?>
        <div class="konten">
