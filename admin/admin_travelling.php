...
$query_list   = "select id_posting, date, judul, artikel, gambar from posting where kriteria = 'Travelling' order by id_posting desc";
...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="admin_travelling.php">Cerita Kami</a></li>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
          <h2>Daftar Posting Cerita Kami</h2><br>
