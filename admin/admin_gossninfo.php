...
$query_list		= "select id_posting, date, judul, artikel, gambar from posting where kriteria = 'Gossip & Info Terkini' order by id_posting desc";
...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="admin_gossninfo.php">Info Terkini</a></li>
            <li><a href="admin_travelling.php">Cerita Kami</a></li>
            <li><a href="admin_tipsntrik.php">Tips & Trik</a></li>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
          <h2>Daftar Posting Info Terkini</h2><br>
