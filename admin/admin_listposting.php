...
$query_list		= "select id_posting, date, judul, kriteria, artikel, gambar from posting order by id_posting desc";
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="admin_listposting.php">List Posting</a></li>
      ...
      <div class="jumbotron">
          ...
          <table width="1000" border="1">
            <tr bgcolor="#197575">
            	...
            	<td class="judultabel" width="120" align="center"><b>Kriteria</b></td>
            ...
            while($row = mysql_fetch_assoc($list_posting))
            {
            	...
            	<td class="isitabel" align="center" valign="top"><?php echo $row["kriteria"]; ?></td>
            	...
            	<td class="isitabel" align="center" valign="top"><a href="posting_form.php?posting=<?php echo $row["id_posting"];?>">[view]<br></a><a href="posting_hapus.php?posting=<?php echo $row["id_posting"];?>"onclick="return confirm('Delete Posting?')">[delete]<br></a></td>
            </tr>
            <?php
            $i++;
